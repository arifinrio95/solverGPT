        ...
        "messages": [
          {
            ...
            "content": [
              {
                "type": "text",
                "text": "Jawab pertanyaan di gambar ini dengan penjelasannya. Jawab semuanya dalam plain text, jangan ada simbol yang tidak bisa dishow dengan fungsi print di python."
              },
              {
                "type": "image_url",
                "image_url": {
